...
// Styles
import styles from './Styles/JadwalAkomodasiScreenStyle'

export default class JadwalAkomodasiScreen extends Component {
    render() {
        return (
            <ScrollView>
                <View style={styles.konten}>
                    <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
                        <View style={{ flexDirection: 'row' }}>
                            ...
                            />
                            <Text style={styles.teks}>JADWAL AKOMODASI</Text>
                        </View>
                ...
                <View style={styles.container}>
                    ...
                    <View style={{ marginTop: 10 }}>
                        <Text style={{color: '#bdbdbd'}}>18 Oktober 2021</Text>
                    </View>
                    <View style={{ marginTop: 10 }}>
                        <CardKedatangan
                            namaProvinsi='Aceh'
